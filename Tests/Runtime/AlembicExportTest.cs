...
namespace UnityEditor.Formats.Alembic.Exporter.UnitTests
{
    ...
    public class AlembicExportTest : AlembicTestBase
    {
        ...
        {
            yield return SceneLoader("Packages/com.unity.formats.alembic.tests/Tests/Runtime/Data/TestCloth.unity");
            var exporter = GetAlembicExporter();
            var exportFile = SetupExporter(exporter);
        ...
        {
            yield return TestScene("Packages/com.unity.formats.alembic.tests/Tests/Runtime/Data/TestCloth.unity");
        }
        ...
        {
            yield return TestScene("Packages/com.unity.formats.alembic.tests/Tests/Runtime/Data/TestExport.unity");
        }
        ...
        {
            yield return TestScene("Packages/com.unity.formats.alembic.tests/Tests/Runtime/Data/TestCustomCapturer.unity");
        }
        ...
        {
            yield return SceneLoader("Packages/com.unity.formats.alembic.tests/Tests/Runtime/Data/TestGUI.unity");
            var exporter = GetAlembicExporter();
            var exportFile = SetupExporter(exporter);
        ...
        {
            yield return SceneLoader("Packages/com.unity.formats.alembic.tests/Tests/Runtime/Data/TestExport.unity");
            var exporter = GetAlembicExporter();
            var exportFile = SetupExporter(exporter);
        ...
        {
            yield return SceneLoader("Packages/com.unity.formats.alembic.tests/Tests/Runtime/Data/TestCustomCapturer.unity");
            var exporter = GetAlembicExporter();
            var exportFile = SetupExporter(exporter);
